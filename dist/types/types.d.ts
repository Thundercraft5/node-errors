...
export type FormattableMessageParams<M extends MessageMap, Code extends string> = Required<Parameters<Exclude<M[Code], string>>>;
...
export type MessageDescriptor<E extends ErrorsDescriptor> = MessageMap & {
