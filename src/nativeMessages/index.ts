...
const messages = {
	...
	OBJECT_PROPERTY_NOT_EXTENSIBLE: (object: any, key: number | string | symbol) => `Cannot add property '${ String(key) }', object '${ toRepresentation(object) } is not extensible'`,
	OBJECT_NOT_EXTENSIBLE: (object: any, key: number | string | symbol) => `'${ toRepresentation(object) } is not extensible'`,
